...
def test_multidut_cold_reboot(cvg_api, duthosts, localhost, get_multidut_snappi_ports):
    ...
    logger.info("Verify convergence with cold reboot scenario")
    table = get_convergence_for_reboot_test(duthosts, localhost, cvg_api, 'cold')
    ...
    pytest_assert(result == True, 'Test case test_multidut_cold_reboot failed')
