...
def test_multidut_warm_reboot(cvg_api, duthosts, localhost, get_multidut_snappi_ports):
    ...
    table = get_convergence_for_reboot_test(duthosts, localhost, cvg_api, 'warm')
    ...
    pytest_assert(result == True, 'Test case test_multidut_warm_reboot failed')
